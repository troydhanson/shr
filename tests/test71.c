...
struct events {
  ...
  ops op;
    ...
    {4, W, do_fill}, /* seq 0-9 */
    {5, W, do_fill}, /* seq 10-19 */

    {6, F, do_read_one}, /* seq 10 */
    {7, R, do_read_one}, /* seq 10 */
    {8, R, do_read_one}, /* seq 11 */
    {9, R, do_read_one}, /* seq 12 */
   {10, F, do_read_one}, /* seq 11 */

   {11, W, do_fill}, /* seq 20-29 */

   {12, F, do_read_half}, /* seq 20-24 */
   {13, R, do_read_half}, /* seq 20-24 */
