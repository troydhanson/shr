...
#define OPS o(do_none) o(do_open) o(do_write_one) o(do_flush_wait) o(do_flush_nb) o(do_stat) o(do_read_one) \
 o(do_close) o(do_exit)
#define o(x) #x,
char *op_s[] = { OPS };
#undef o
#define o(x) x,
...
struct events {
  ...
  ops op;
    ...
    { W, do_write_one}, /* writes seq 0 to cache */
    { W, do_write_one}, /* writes seq 1 to cache; flushes seq 0 to ring */
    { W, do_stat},

    { W, do_flush_nb},  /* wants to flush but would block */
    { R, do_read_one},  /* gets sequence 0 */
    { W, do_flush_nb},  /* flushes seq 1 from cache */
    { R, do_read_one},  /* gets sequence 1 */

    { W, do_stat},
    { W, do_flush_wait},/* this is a no-op since cache is empty */
    { W, do_stat},
