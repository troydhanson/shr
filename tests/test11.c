...
#define OPS o(do_none) o(do_open) o(do_fill) o(do_read_half) o(do_read_one) \
 o(do_farm_stat) o(do_close) o(do_exit)
#define o(x) #x,
char *op_s[] = { OPS };
#undef o
#define o(x) x,
...
struct events {
  ...
  ops op;
    ...
    { F, do_read_one},  /* seq 0 */
    { R, do_read_half}, /* seq 0-4 */
      
    { W, do_fill}, /* seq 10-19 */

    { F, do_farm_stat},  /* 0 drops - no read yet */
    { R, do_farm_stat},  /* 0 drops - no read yet */
      
    { F, do_read_one},  /* seq 10 */
    { R, do_read_one},  /* seq 10 */
      
    { F, do_farm_stat},  /* 9 drops - and reset */
    { R, do_farm_stat},  /* 5 drops - and reset */
      
    { F, do_farm_stat},  /* 0 drops */
    { R, do_farm_stat},  /* 0 drops */
