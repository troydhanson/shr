...
struct events {
  ...
  ops op;
    ...
    /* mv NOT filled but ring filled */

    { R, do_stat},          /* mu 8 */
    { R, do_read_one},      /* read AAAAA */

    { W, do_write_one_5b},  /* write IIIII, overwrite AAAAA */
    { R, do_read_one},      /* read BBB */
    { R, do_read_one},      /* read C */

    /* farm reader */
    { F, do_open},
    { F, do_stat},          /* mu 8 */
    { F, do_read_one},      /* read BBB */
    { F, do_read_one},      /* read C */

    { W, do_write_one_5b},  /* write JJJJJ, overwrites [BBBCD]; eldest: E  */

    { R, do_read_one},      /* read E */
    { F, do_read_one},      /* read E */

    { R, do_read_one},      /* read FFFFF */
    { W, do_write_one_5b},  /* write KKKKK, overwrites [DDEFF]; eldest: G */
    ...
    { W, do_write_one_5b},  /* write LLLLL, overwrites [FFFGH] eldest: IIIII */
    { R, do_read_one},      /* read KKKKK */
